...
if(isset($_POST['publish'])){
   ...
   if($select_image->rowCount() > 0 AND $image != ''){
      ...
      $insert_post = $conn->prepare("INSERT INTO `posts`(admin_id, name, title, content,  image, status, topic_id) VALUES(?,?,?,?,?,?, ?)");
      $insert_post->execute([$admin_id, $name, $title, $content, $image, $status, $topic_id]);
