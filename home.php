...
<section class="home-grid">
   ...
   <div class="box-container">
      ...
      <!-- <div class="box">
         <p>categories</p>
         <div class="flex-box">
            <a href="category.php?category=foods and drinks" class="links">Foods and Drinks</a>
      ...
      <form class="box" method="post">
         ...
         <div class="post-admin">
            ...
            <div>
               ...
               <div><?= date_format(date_create($fetch_posts['date']), "Y jS M G:i:s A"); ?></div>
            </div>
         </div>
         ...
         <a href="category.php?category=<?= $topic ? $topic['id'] : 0; ?>" class="post-cat"> <i class="fas fa-tag"></i> <span><?= $topic ? $topic['name'] : 'Uncategorized'; ?></span></a>
         <div class="icons">
